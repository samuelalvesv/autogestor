---
name: identity-multitenancy
description: ASP.NET Identity, Multi-Tenancy strategy, Tenant/Branch/User cardinalities, TenantEntity query filters, and IBranchAuthorizationService. Use this rule when working with authentication, JWT generation, tenant context, branch authorization checks, or claims.
---
