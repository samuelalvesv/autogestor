...
> [!NOTE]
> By default, if you have an active project open, clicking Settings will automatically open the configurations for that specific project. Otherwise, it will open the global settings.
