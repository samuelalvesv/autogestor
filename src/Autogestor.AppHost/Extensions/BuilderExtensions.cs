...
{
    public static IDistributedApplicationBuilder ConfigureAppTopology(this IDistributedApplicationBuilder builder)
    {
        ...
        builder.AddProject<Projects.Autogestor_Web>(name: "web").WithReference(source: api);
