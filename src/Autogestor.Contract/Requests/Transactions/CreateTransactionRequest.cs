...
public sealed record CreateTransactionRequest
{
    ...
    [EnumDataType(enumType: typeof(ETransactionType), ErrorMessage = "Tipo de transação inválido")]
    public required ETransactionType Type { get; init; }

    [DataMember(Order = 3)]
    [Required(ErrorMessage = "Valor inválido")]
    [Range(minimum: 0.01, maximum: (double)decimal.MaxValue, ErrorMessage = "O valor deve ser maior que zero")]
