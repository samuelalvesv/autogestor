...
namespace Autogestor.IntegrationTests.Services;

public class CategoryServiceTests
{
    private sealed class FakeCreateCategoryUseCase : ICreateCategoryUseCase
    {
    ...
    {
        // Arrange
        var fakeUseCase = new FakeCreateCategoryUseCase();
        var service = new CategoryService(createCategoryUseCase: fakeUseCase);
        ...
        fakeUseCase.ResponseToReturn = expectedResponse;
        ...
        Assert.Same(expected: request, actual: fakeUseCase.ReceivedRequest);
    }
    ...
    public async Task CreateAsync_PropagatesCancellationToken()
    {
        ...
        fakeUseCase.ResponseToReturn = new Response<CategoryResponse>
        {
            Data = null,
            Message = "Sucesso"
        };
        ...
        // Assert
        Assert.Equal(expected: token, actual: fakeUseCase.ReceivedCancellationToken);
    }
